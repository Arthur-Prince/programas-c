...
//cria uma estrutura com a chave e chama ela de registro
typedef struct {
  TIPOCHAVE chave;
  // outros campos...
} REGISTRO;

// cria uma estrutura q contem registro e um ponteiro para outra estrutura do
//mesmo tipo e por fim chama esta estrutra de elemento
typedef struct tempRegistro{
  REGISTRO reg;
  struct tempRegistro* prox;
} ELEMENTO;
//chama o poteiro para elemento de pont
typedef ELEMENTO* PONT;
//diz onde esta o primeiro ponteiro para elemento da lista
typedef struct {
  PONT inicio;
} LISTA;
